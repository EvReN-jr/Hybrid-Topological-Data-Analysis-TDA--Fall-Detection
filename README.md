...
All signals are resampled to a standardized frequency:
...
Total TDA features: 20
Additional acceleration statistics: 4

Final feature vector dimension: 24
...
Decision thresholds are selected using Precision-Recall curves to maximize F2-score rather than default 0.5 probability.
...
Subject-independent evaluation is critical for real-world deployment.
